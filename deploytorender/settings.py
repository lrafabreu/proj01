...
ALLOWED_HOSTS += "lrafabreu.pythonanywhere.com"
...
ROOT_URLCONF = 'deploytorender.urls'
...
WSGI_APPLICATION = 'deploytorender.wsgi.application'
...
if DEBUG:
    EMAIL_HOST = os.getenv('EMAIL_HOST_VAL', 'nil')
    EMAIL_HOST_USER = os.getenv('EMAIL_HST_USR_VAL', 'nil')
    EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PWD_VAL', 'nil')
